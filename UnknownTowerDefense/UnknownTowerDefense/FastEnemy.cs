...
namespace UnknownTowerDefense
{
    class FastEnemy : Enemy
    {
        ...
        public FastEnemy(Texture2D texture, Vector2 position, float health, int bountyGiven, float speed)
            : base(texture, position, health, bountyGiven, speed)
        {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            if (alive)
            {
                ...
                {
                    color = new Color(new Vector3(255, 0, 0));
                }
